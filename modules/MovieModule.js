...
function onclickMovieName(a){
  if(a==1)
    movieNameVal="Mad Max Fury Road";
  else if(a==2)
    movieNameVal="The Martian";
  else if(a==3)
    movieNameVal="Star Wars";
  else if(a==4)
    movieNameVal="Guardians of the Galaxy";
  else if(a==5)
    movieNameVal="Interstellar";
  else if(a==6)
    movieNameVal="Attack of the Herbals";
  else if(a==7)
    movieNameVal="Shoot Out";
  else if(a==8)
    movieNameVal="Prometheus";
  else if(a==9)
    movieNameVal="Serenity";
  showLdngScreen();
  afterCompletion();
